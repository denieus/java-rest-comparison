...
**Prerequisites:** https://adoptium.net/[Java 11]+ and http://maven.apache.org/[Maven].
...
. Run the https://github.com/oktadev/okta-maven-plugin[Okta Maven Plugin] to create an Okta account, or https://developer.okta.com/signup/[signup through your browser].
+
[source,shell]
----
...
. For Quarkus, use `java -jar target/quarkus-app/*.jar`
...
⚡️ Find the code on GitHub: https://github.com/oktadev/okta-java-rest-api-comparison-example[@oktadeveloper/okta-java-rest-api-comparison-example].
